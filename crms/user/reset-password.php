...
<main>
    <div id="primary" class="blue4 p-t-b-100 height-full responsive-phone">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
              <img src="assets/img/icon/avatar.png" alt="avatar" style="padding:10%">
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                 <input type="password" name="newpassword" class="orm-control form-control-lg" placeholder="New Password" required="true">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group has-icon"><i class="icon-user-secret"></i>
                                <input type="password" name="confirmpassword" class="form-control form-control-lg no-b" placeholder="Confirm Password" required="true">
                                </div>
                            </div>
                            <div class="col-lg-12">

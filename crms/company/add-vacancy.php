...
if(isset($_POST['submit']))
  {
    ...
    $salary=$_POST['salary'];
    $jobdecs=addslashes($_POST['jobdecs']);
                ...
                <div class="col">
                    <h4>
                        ...
                        <div class="card-body b-b">
                            <form method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control" id="jobdecs" name="jobdecs" 
                                           placeholder="Job Descriptions" rows="6" required="true"></textarea>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-title" style="padding-top: 20px">Apply From Date</div>
                            <div class="input-group">
                                <input type="text" class="date-time-picker form-control"
                                       data-options='{"timepicker":false, "format":"d-m-Y"}' value="" id="applydate" name="applydate" required="true">
                            ...
                            <div class="input-group">
                                <input type="text" class="date-time-picker form-control"
                                       data-options='{"timepicker":false, "format":"d-m-Y"}' value="" id="lastdate" name="lastdate" required="true">
                                <span class="input-group-append">
                                    <span class="input-group-text add-on white">
                                        <i class="icon-calendar"></i>
                                    </span>

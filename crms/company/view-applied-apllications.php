...
<head>
    ...
    <title>Campus Recruitment Management System-Apply Vacancy</title>
    <!-- CSS -->
...
<table class="table table-bordered table-hover data-tables">
  ...
  <td><a href="view-education-detail.php?eduid=<?php echo $row['uid'];?>&&cname=<?php  echo $row['FullName'];?>" target="_blanks">Candidate Education Details</a></td>
  </tr>
   <tr>
  <th>Resume </th>
...
<tr>
 ...
 <td><?php  echo $row1['Message'];?></td> 
  <td><?php  echo $jstatus=$row1['comstatus'];?></td> 
   <td><?php  echo $row1['ResponseDate'];?></td> 
</tr>
<?php $cnt=$cnt+1;} ?>
</table>
<?php  }  
if ($row['Status']=="" || $row['Status']=="Sorted"){
?> 
<p align="center">                            
...
<th>Message :</th>
<td>
<textarea name="message" placeholder="Message" rows="6" cols="14" class="form-control wd-450" required="true"></textarea></td>
  </tr>                           
  ...
  <tr>
   ...
   <select name="status" class="form-control wd-450" required="true" >
    ...
    <?php if($jstatus==''): ?>
     ...
     <option value="Sort Listed">shortlisted</option>
 <?php elseif($jstatus=='Sort Listed'): ?>

...
<aside class="main-sidebar fixed offcanvas shadow">
    <section class="sidebar">
        ...
        <h2 align="center"> CRMS | Company</h2>
        </div>
        <div class="relative">
...
<img class="user_avatar" src="images/<?php echo $logo; ?>" alt="<?php echo $name; ?>" height="60">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="#">
                <i class="icon icon icon-file blue-text s-18"></i>
           Post Vacancy <i
...
<li><a href="new-applications.php"><i class="icon icon-circle-o"></i> New Applications</a>
        ...
        <li><a href="selected-applications.php"><i class="icon icon-check"></i>Selected Applications</a>
                    </li>

...
<a class="dropdown-item" href="view-applied-apllications.php?viewid=<?php echo $result['ID'];?>"><i class="icon icon-data_usage text-success"></i>New Application Received from <?php echo $result['FullName'];?></a>
                </li>
<?php } }  else {?>
